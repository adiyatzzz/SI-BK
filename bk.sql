...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2019 at 06:40 AM
...
CREATE TABLE `pelanggaran` (
  `id` int(11) NOT NULL,
  `pelanggaran` varchar(1000) NOT NULL,
  `poin` int(100) NOT NULL,
  `kls_plgr` varchar(200) NOT NULL,
  `tgl_pelanggaran` date NOT NULL,
  `nama_plgr` varchar(255) NOT NULL,
  `nis_plgr` int(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
